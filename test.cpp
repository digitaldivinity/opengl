...
void init(){
	...
	//отдельно для солнца, будем светить из камеры на солнце
...
void Display(void){
	...
	glPushMatrix();
	glLoadIdentity();
	glLightfv(GL_LIGHT1,GL_POSITION,light_for_sun);
	glPopMatrix();
